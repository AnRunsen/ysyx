...
#define KBD_ADDR ((volatile uint8_t *)0x10011000)
...
static const int ext_keymap[256] = {
  [0x11] = AM_KEY_RALT,
  [0x14] = AM_KEY_RCTRL,
...
void __am_input_keybrd(AM_INPUT_KEYBRD_T *kbd) {
  ...
  kbd->keycode = extended_code ? ext_keymap[scancode] : keymap[scancode];
  if (kbd->keycode != AM_KEY_NONE) {
    kbd->keydown = !break_pending;
  }
